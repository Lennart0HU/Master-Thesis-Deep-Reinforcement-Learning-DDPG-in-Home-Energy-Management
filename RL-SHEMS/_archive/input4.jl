...
function set_hyperparameters(job_id)
  ...
  params = Dict(
      ...
      :penalty => 1, # REMEMBER TO ADJUST THIS IN ENV
      :TRAIN_EP_LENGTH => 72,
      :NUM_EP => 1_001,
      :BATCH_SIZE => 120,
      :MEM_SIZE => 24_000,
  ...
  alt_values = Dict(
      1 => (1.5, :DISCOMFORT_WEIGHT_EV),# REMEMBER TO ADJUST THIS IN ENV
      2 => (3, :DISCOMFORT_WEIGHT_EV),# REMEMBER TO ADJUST THIS IN ENV
      3 => (0.1, :penalty), # REMEMBER TO ADJUST THIS IN ENV
      4 => (0.5, :penalty),# REMEMBER TO ADJUST THIS IN ENV
...
include("../../RL_environments/envs/shems_LU1_input4.jl")
