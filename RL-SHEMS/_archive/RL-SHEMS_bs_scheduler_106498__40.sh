...
start_time=$SECONDS
MIN_MEMORY=30000
MIN_SYS_MEMORY=75000000 # Minimum system memory in KB (adjust as needed)
...
for JOB_ID in "${JOB_IDS[@]}"; do
    export JOB_ID
    cp input04_40.jl out/input/$JOB_ID--input.jl
    ...
    export JOB_ID
    cp input05_40.jl out/input/$JOB_ID--input.jl
