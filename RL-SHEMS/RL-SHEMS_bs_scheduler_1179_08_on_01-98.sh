...
while ((JOB_ID <= 11790908))
do
#for JOB_ID in "${JOB_IDS[@]}"; do
    export JOB_ID
    cp input09_08_on_01-09_eval.jl out/input/$JOB_ID--input.jl
...
while ((JOB_ID <= 11810908))
do
#for JOB_ID in "${JOB_IDS[@]}"; do
    export JOB_ID
    cp input09_08_on_01-09_test.jl out/input/$JOB_ID--input.jl
