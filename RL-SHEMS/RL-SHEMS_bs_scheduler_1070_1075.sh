...
start_time=$SECONDS
MIN_MEMORY=25000
MIN_SYS_MEMORY=50000000 # Minimum system memory in KB (adjust as needed)
...
while ((JOB_ID <= 10749815))
do
    export JOB_ID
    cp input04_PS_eval.jl out/input/$JOB_ID--input.jl
...
while ((JOB_ID <= 10759815))
do
    export JOB_ID
    cp input05_PS_test.jl out/input/$JOB_ID--input.jl
